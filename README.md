...
- [Backlog](docs/backlog.md) — what is worth doing next and why, ordered by real exposure over effort, with the two architectural candidates that turned out to be answers rather than tasks.
